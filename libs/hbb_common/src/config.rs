...
pub const RENDEZVOUS_SERVERS: &[&str] = &["yc.bch.local"];
pub const PUBLIC_RS_PUB_KEY: &str = "FOMheCNKWtu+GljbB5imnCmYGk5AvYhi6v4xk81Chnc=";
...
pub mod keys {
    ...
    pub const OPTION_DIRECT_SERVER: &str = "direct-server=Y";
